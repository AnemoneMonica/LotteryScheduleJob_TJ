...
public class DateTool {
	 ...
	 * @throws ParseException
	 */
	public static String strSwapFormat(String ds, String oldFormat,
	 ...
	 * @throws ParseException
	 */
	public static Date getSAfterToD(Date d, int sAfter) throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static String getSAfterToS(Date d, int sAfter) throws ParseException {
		Calendar c = Calendar.getInstance();
		c.setTime(d);
		c.add(Calendar.SECOND, sAfter);
		Date dt = new Date(c.get(Calendar.YEAR) - 1900, c.get(Calendar.MONTH),
	...
	public static String getStreamId() {
		...
		return new StringBuffer().append(machineName).append(time)
